...
namespace app {
    ...
    void MainController::draw_terrain() {
        ...
        model           = glm::translate(model, glm::vec3(30.0f, -15.0f, 0.0f));
    ...
    void MainController::draw_columns() {
        ...
        model1 = glm::translate(model1, glm::vec3(16.5f, -15.0f, 13.0f)); // front left
        model1 = glm::scale(model1, glm::vec3(1.0f));

        model2 = glm::translate(model2, glm::vec3(44.5f, -15.0f, 13.0f)); // back left
        model2 = glm::scale(model2, glm::vec3(1.0f));

        model3 = glm::translate(model3, glm::vec3(16.5f, -15.0f, -12.5f)); // front right
        model3 = glm::scale(model3, glm::vec3(1.0f));

        model4 = glm::translate(model4, glm::vec3(44.5f, -15.0f, -12.5f)); // back right
    ...
    void MainController::draw_butterfly_instanced() {
        ...
        float radius = 15.0;
        float offset = 5.0f;
        glm::vec3 gazeboPos = glm::vec3(30.0f, -3.0f, 0.0f);
        ...
        for (unsigned int i = 0; i < butterfly->meshes().size(); i++) {
            ...
            glDrawElementsInstanced(GL_TRIANGLES, static_cast<unsigned int>(butterfly->meshes()[i].m_num_indices), GL_UNSIGNED_INT, 0, amount);
        }
    ...
    void MainController::draw_statue() {
        ...
        model           = glm::translate(model, glm::vec3(30.0f, -14.0f, 0.0f));
        model           = glm::rotate(model, angle, glm::vec3(0, 1, 0));
